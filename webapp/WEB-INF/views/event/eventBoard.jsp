...
<html>
				...
				<form method="post" action="${pageContext.request.contextPath }/group/addMeeting" >
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" id="datePicker" class="form-control" value="2021-04-05">
						</div>
						
						<div class="form-group">
							<label class="form-text">마감일</label>
							<input type="text" id="datePicker" class="form-control" value="2021-04-06">
						</div>
	...
	<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}/assets/css/bootstrap-datepicker.ko.js"></script>
