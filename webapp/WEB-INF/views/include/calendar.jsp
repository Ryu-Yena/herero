...
<script src="${pageContext.request.contextPath}/assets/js/alpine.js" defer></script>
...
<body class="antialiased sans-serif bg-gray-100">
  <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container mx-auto px-4 py-2 md:py-23" style="background-color:#f4f4f4; border-radius: 20px; ">
      ...
      <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
        ...
        <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
         ...
         <div class="inline-block w-64 mb-4">
            <label class="text-gray-800 block mb-1 font-bold text-sm tracking-wide">Select a label</label>
            <div class="relative">
          ...
          <div class="mb-4">
            <label class="text-gray-800 block mb-1 font-bold text-sm tracking-wide">Event detail</label>
